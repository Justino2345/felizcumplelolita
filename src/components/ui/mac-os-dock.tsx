  ...
  const padding = Math.max(8, baseIconSize * 0.12);
    ...
    <div
      ...
      style={{
        ...
        boxShadow: `
          0 ${Math.max(8, baseIconSize * 0.22)}px ${Math.max(28, baseIconSize * 0.7)}px rgba(0, 0, 0, 0.22),
      ...
      >
        {apps.map((app, index) => {
          ...
          return (
            ...
            >
              {/* macOS-style name tooltip */}
              {hoveredIndex === index && (
                <div
                  className="pointer-events-none absolute left-1/2 -translate-x-1/2 whitespace-nowrap"
                  style={{
                    bottom: '100%',
                    marginBottom: `${Math.max(9, baseIconSize * 0.2)}px`,
                    padding: '3px 9px',
                    fontSize: `${Math.max(11, baseIconSize * 0.17)}px`,
                    lineHeight: 1.25,
                    fontWeight: 450,
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      ...
                      borderTop: '4px solid rgba(28, 28, 30, 0.72)',
                    }}
                  />
                </div>
              )}
              ...
              {openApps.includes(app.id) && (
                <div
                  ...
                  style={{
                    ...
                    width: `${Math.max(2.5, baseIconSize * 0.045)}px`,
                    height: `${Math.max(2.5, baseIconSize * 0.045)}px`,
                    borderRadius: '50%',
