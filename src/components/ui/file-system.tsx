...
// framework glyphs — ships as an SVG sprite.
...
function FileSystemSearchField({
  ...
  const input = (
    <div
      className={cn(
        "relative flex h-7 min-w-0 flex-1 items-center rounded-lg border border-input bg-popover text-sm text-foreground shadow-xs/5 transition-shadow outline-none focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-1 focus-within:ring-offset-background dark:bg-input/32",
        isInline && "max-w-56"
      )}
    >
      <HugeiconsIcon
